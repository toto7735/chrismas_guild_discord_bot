...
API = "12cff943-3b01-4e5d-88e8-7ec7abfb16a1"
...
@slash.slash(name="ping",description="봇의 속도를 확인하는 명령어 시스템입니다.",guild_ids=[536526007906074624,879026494771462174])
async def ping(ctx:SlashContext):
    ping=round(client.latency * 1000)
    ping=round(1000/ping)
    await ctx.reply(f"봇의 속도: {ping}초")
